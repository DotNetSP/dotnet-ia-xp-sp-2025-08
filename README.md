...
Tecnologias e tópicos abordados: **.NET, C#, ASP.NET Core, MCP, NuGet, Inteligência Artificial, LLMs, Visual Studio Code, GitHub Copilot, GitHub, SQL Server, Docker, Docker Compose, Docker Hub, Docker MCP Catalog, OpenTelemetry...**
...
![Público 2](img/19.jpg)

![Local do evento](img/16.jpg)

![Coffee-break](img/61.jpg)